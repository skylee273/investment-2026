...
const ACTUAL_HOLDINGS = {
  overseas: {
    ...
    holdings: [
      ...
      { name: '기아', investedKRW: 474600, currentKRW: 480000, gainKRW: 5400, gainPercent: 1.14 },
      { name: '삼성화재', investedKRW: 943000, currentKRW: 923000, gainKRW: -20000, gainPercent: -2.12 },
      { name: 'SK텔레콤', investedKRW: 396400, currentKRW: 401200, gainKRW: 4800, gainPercent: 1.21 },
      { name: '하나금융지주', investedKRW: 743400, currentKRW: 717000, gainKRW: -26400, gainPercent: -3.55 },
      { name: '케이뱅크', investedKRW: 83000, currentKRW: 63700, gainKRW: -19300, gainPercent: -23.25 },
      { name: 'CMA (발행어음)', investedKRW: 10056989, currentKRW: 10063001, gainKRW: 6012, gainPercent: 0.06 },
      { name: '비트코인 (BTC)', investedKRW: 1098351, currentKRW: 1344337, gainKRW: 245986, gainPercent: 22.40 },
    ],
  },
  isa: {
...
const PORTFOLIOS = {
  overseas: {
    ...
    items: [
      { ticker: 'VOO', name: 'Vanguard S&P500 ETF', category: '해외ETF', targetWeight: 55, risk: 3 },
      { ticker: 'SCHD', name: 'Schwab 배당주 ETF', category: '해외ETF', targetWeight: 13, risk: 2 },
      { ticker: 'AMZN', name: '아마존', category: '개별주식', targetWeight: 5, risk: 4 },
      { ticker: 'CVX', name: '셰브론', category: '개별주식', targetWeight: 5, risk: 3 },
      { ticker: 'UNH', name: '유나이티드헬스', category: '개별주식', targetWeight: 10, risk: 3 },
      { ticker: 'KR_STOCKS', name: '국내주식 (기아, 삼성화재 등)', category: '국내주식', targetWeight: 7, risk: 3 },
      { ticker: 'BTC', name: '비트코인', category: '암호화폐', targetWeight: 4, risk: 5 },
      { ticker: 'CMA', name: 'CMA 발행어음', category: '현금성', targetWeight: 1, risk: 1 },
    ],
  },
  isa: {
    id: 'isa',
...
const ETF_DETAILS = {
  'VOO': {
    fullName: 'Vanguard S&P500 ETF',
    benchmark: 'S&P 500 Index',
    expense: '0.03%',
    description: '세계 최대 규모의 S&P500 추종 ETF. 미국 대형주 500개에 분산 투자.',
    ...
    performance: { ytd: '+8.5%', oneYear: '+27.1%', threeYear: '+10.3%' },
    pros: ['세계 최저 보수 0.03%', '장기 연평균 10% 수익률', '달러 자산'],
    cons: ['미국 경제 100% 의존', '빅테크 편중 35%', '환율 변동 리스크'],
    verdict: '장기 투자의 정석. 묻어두고 잊어버려도 되는 ETF.',
    grade: 'S',
  },
  'SCHD': {
    fullName: 'Schwab US Dividend Equity ETF',
    benchmark: 'Dow Jones U.S. Dividend 100 Index',
    expense: '0.06%',
    description: '미국 고배당 대형주 100개에 투자. 배당 성장과 안정성 중시.',
    holdings: ['홈디포 4.3%', '시스코 4.2%', '암젠 4.1%', '코카콜라 4.0%', 'UPS 3.8%'],
    sectors: [
      { name: '금융', weight: 19.8, color: '#00C853' },
      { name: '헬스케어', weight: 15.2, color: '#FF5722' },
      { name: '산업재', weight: 13.5, color: '#9C27B0' },
      { name: 'IT', weight: 12.8, color: '#3182F6' },
      { name: '기타', weight: 38.7, color: '#B0BEC5' },
    ],
    performance: { ytd: '+5.2%', oneYear: '+18.3%', threeYear: '+8.5%' },
    pros: ['연 배당 3.5%+', '배당 성장률 10년 연속', '낮은 변동성'],
    cons: ['성장주 대비 상승폭 제한', '금리 인상에 민감', '기술주 비중 낮음'],
    verdict: '배당으로 현금흐름 + 안정적 성장. VOO와 최고의 조합.',
    grade: 'S',
  },
  'AMZN': {
    fullName: '아마존 (Amazon.com)',
    benchmark: 'Individual Stock',
    expense: '-',
    description: '전자상거래 + AWS 클라우드 세계 1위. AI 인프라 핵심 수혜주.',
    holdings: ['전자상거래 40%', 'AWS 클라우드 60%'],
    sectors: [
      { name: 'AWS (클라우드)', weight: 60, color: '#FF9800' },
      { name: '이커머스', weight: 40, color: '#3182F6' },
    ],
    performance: { ytd: '+12.5%', oneYear: '+35.2%', threeYear: '+15.1%' },
    pros: ['AWS 시장점유율 1위', 'AI 인프라 수혜', '프라임 구독 효과'],
    cons: ['개별주 리스크', '반독점 규제', '높은 PER'],
    verdict: '기술 성장주의 대표. 장기 보유 시 높은 수익 기대.',
    grade: 'A+',
  },
  'CVX': {
    fullName: '셰브론 (Chevron)',
    benchmark: 'Individual Stock',
    expense: '-',
    description: '세계 2위 에너지 기업. 배당 귀족주 (37년 연속 인상).',
    holdings: ['원유 생산 45%', '정유 35%', '천연가스 20%'],
    sectors: [
      { name: '원유 생산', weight: 45, color: '#424242' },
      { name: '정유', weight: 35, color: '#FF5722' },
      { name: '천연가스', weight: 20, color: '#10B981' },
    ],
    performance: { ytd: '+8.2%', oneYear: '+15.5%', threeYear: '+12.8%' },
    pros: ['배당 수익률 4%+', '37년 연속 배당 인상', '에너지 인플레 헤지'],
    cons: ['유가 변동 영향', 'ESG 리스크', '에너지 전환 불확실성'],
    verdict: '배당 투자의 정석. 에너지 섹터 대표 우량주.',
    grade: 'A',
  },
  'UNH': {
    fullName: '유나이티드헬스 (UnitedHealth)',
    benchmark: 'Individual Stock',
    expense: '-',
    description: '미국 최대 건강보험사 + 옵텀(헬스케어 서비스).',
    holdings: ['건강보험 60%', '옵텀 헬스케어 40%'],
    sectors: [
      { name: '건강보험', weight: 60, color: '#3182F6' },
      { name: '헬스케어 서비스', weight: 40, color: '#10B981' },
    ],
    performance: { ytd: '+6.8%', oneYear: '+22.1%', threeYear: '+14.5%' },
    pros: ['미국 인구 고령화 수혜', '안정적 현금흐름', '경기방어적 특성'],
    cons: ['정치적 리스크 (보험개혁)', '개별주 리스크', '높은 주가'],
    verdict: '헬스케어 섹터 최고 우량주. 장기 안정성 확보.',
    grade: 'A',
  },
  'KR_STOCKS': {
    fullName: '국내 배당주 (기아, 삼성화재, SKT, 하나금융)',
    benchmark: 'Individual Stocks',
    expense: '-',
    description: '국내 고배당 가치주 바스켓. 배당으로 현금흐름 확보.',
    holdings: ['삼성화재 35%', '하나금융 27%', '기아 18%', 'SK텔레콤 15%', '케이뱅크 5%'],
    sectors: [
      { name: '금융', weight: 62, color: '#00C853' },
      { name: '자동차', weight: 18, color: '#FF5722' },
      { name: '통신', weight: 15, color: '#9C27B0' },
      { name: '핀테크', weight: 5, color: '#3182F6' },
    ],
    performance: { ytd: '-1.2%', oneYear: '+5.3%', threeYear: '+2.1%' },
    pros: ['배당 수익률 4~7%', '배당소득 분리과세', '원화 자산 분산'],
    cons: ['코리아 디스카운트', '케이뱅크 손실', '성장성 제한'],
    verdict: '배당 수익 중심으로 장기 보유. 케이뱅크는 손절 검토.',
    grade: 'B+',
  },
  'BTC': {
    fullName: '비트코인 (Bitcoin)',
    benchmark: 'Cryptocurrency',
    expense: '-',
    description: '디지털 골드. 인플레이션 헤지 및 대체 자산.',
    holdings: ['비트코인 100%'],
    sectors: [
      { name: '암호화폐', weight: 100, color: '#F7931A' },
    ],
    performance: { ytd: '+22.4%', oneYear: '+85.3%', threeYear: '+45.2%' },
    pros: ['인플레 헤지', '기관 수요 증가', '희소성 (2100만개 한정)'],
    cons: ['극심한 변동성', '규제 불확실성', '해킹 리스크'],
    verdict: '포트폴리오 1~5% 분산. 장기 보유 권장.',
    grade: 'B',
  },
  'CMA': {
    fullName: 'CMA 발행어음',
    ...
    expense: '-',
    description: '증권사 발행어음 기반 MMF. 원금 보장형 단기 투자.',
    holdings: ['발행어음 100%'],
    sectors: [
      { name: '현금성', weight: 100, color: '#B0BEC5' },
    ],
    performance: { ytd: '+0.06%', oneYear: '+3.2%', threeYear: '+2.8%' },
    pros: ['원금 보장', '즉시 출금 가능', '연 3%+ 수익'],
    cons: ['인플레 대비 실질 손실', '기회비용', '저금리 환경 불리'],
    verdict: '비상금 및 대기자금으로 적합.',
    grade: 'A-',
  },
  '360750': {
