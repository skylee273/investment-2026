...
const US_STOCKS = [
  // 기술
  { ticker: 'AAPL', name: '애플', sector: '기술', per: 28.5, roe: 147.2, dividendYears: 12, pbr: 42.1, price: 266.2, divYield: 0.4, growth1Y: 34.2 },
  { ticker: 'MSFT', name: '마이크로소프트', sector: '기술', per: 35.2, roe: 38.4, dividendYears: 21, pbr: 12.3, price: 391.0, divYield: 0.8, growth1Y: -25.6 },
  { ticker: 'GOOG', name: '구글', sector: '기술', per: 23.1, roe: 25.2, dividendYears: 0, pbr: 5.8, price: 172.5, divYield: 0.0, growth1Y: 8.5 },
  { ticker: 'META', name: '메타', sector: '기술', per: 29.0, roe: 28.1, dividendYears: 1, pbr: 7.2, price: 669.0, divYield: 0.4, growth1Y: -18.7 },
  ...
  // 금융
  { ticker: 'JPM', name: 'JP모건', sector: '금융', per: 14.0, roe: 15.8, dividendYears: 14, pbr: 1.7, price: 310.3, divYield: 1.9, growth1Y: 21.0 },
  { ticker: 'BAC', name: '뱅크오브아메리카', sector: '금융', per: 11.0, roe: 10.2, dividendYears: 11, pbr: 1.1, price: 53.9, divYield: 2.2, growth1Y: 19.5 },
  ...
  // 헬스케어
  { ticker: 'JNJ', name: '존슨앤존슨', sector: '헬스케어', per: 15.8, roe: 21.2, dividendYears: 62, pbr: 5.2, price: 162.5, divYield: 3.0, growth1Y: 2.8 },
  { ticker: 'UNH', name: '유나이티드헬스', sector: '헬스케어', per: 20.1, roe: 25.8, dividendYears: 15, pbr: 5.8, price: 485.5, divYield: 1.4, growth1Y: -8.5 },
  ...
  // 소비재
  { ticker: 'KO', name: '코카콜라', sector: '소비재', per: 24.5, roe: 42.8, dividendYears: 62, pbr: 10.5, price: 72.5, divYield: 3.0, growth1Y: 18.5 },
  { ticker: 'PEP', name: '펩시코', sector: '소비재', per: 25.8, roe: 52.1, dividendYears: 52, pbr: 12.8, price: 158.5, divYield: 2.8, growth1Y: -8.5 },
  ...
  // 산업재
  { ticker: 'CAT', name: '캐터필러', sector: '산업재', per: 16.2, roe: 52.8, dividendYears: 30, pbr: 8.2, price: 365.5, divYield: 1.5, growth1Y: 28.5 },
  ...
  // 에너지
  { ticker: 'XOM', name: '엑슨모빌', sector: '에너지', per: 13.2, roe: 18.5, dividendYears: 42, pbr: 2.1, price: 118.5, divYield: 3.2, growth1Y: 8.2 },
  { ticker: 'CVX', name: '쉐브론', sector: '에너지', per: 14.5, roe: 14.2, dividendYears: 37, pbr: 1.8, price: 148.5, divYield: 4.0, growth1Y: -5.8 },
  ...
  // 통신
  { ticker: 'VZ', name: '버라이즌', sector: '통신', per: 9.2, roe: 18.5, dividendYears: 20, pbr: 1.8, price: 45.8, divYield: 6.2, growth1Y: 12.5 },
  { ticker: 'T', name: 'AT&T', sector: '통신', per: 10.5, roe: 12.8, dividendYears: 40, pbr: 1.2, price: 28.5, divYield: 6.0, growth1Y: 55.8 },
...
const KR_STOCKS = [
  // 기술/반도체
  { ticker: '005930', name: '삼성전자', sector: '기술', per: 15.2, roe: 12.5, dividendYears: 25, pbr: 1.8, price: 219000, divYield: 0.7, growth1Y: 121.7 },
  { ticker: '000660', name: 'SK하이닉스', sector: '기술', per: 8.5, roe: 25.8, dividendYears: 10, pbr: 2.5, price: 1224000, divYield: 0.3, growth1Y: 140.0 },
  { ticker: '035420', name: '네이버', sector: '기술', per: 35.2, roe: 8.5, dividendYears: 5, pbr: 1.5, price: 280000, divYield: 0.4, growth1Y: -18.5 },
  { ticker: '035720', name: '카카오', sector: '기술', per: 42.5, roe: 4.2, dividendYears: 3, pbr: 1.2, price: 58000, divYield: 0.2, growth1Y: -22.5 },
  { ticker: '373220', name: 'LG에너지솔루션', sector: '기술', per: 85.2, roe: 5.8, dividendYears: 1, pbr: 3.5, price: 410000, divYield: 0.2, growth1Y: -15.8 },
  ...
  // 금융
  { ticker: '055550', name: '신한지주', sector: '금융', per: 6.8, roe: 10.5, dividendYears: 20, pbr: 0.9, price: 106000, divYield: 3.5, growth1Y: 118.2 },
  { ticker: '105560', name: 'KB금융', sector: '금융', per: 7.2, roe: 11.8, dividendYears: 15, pbr: 1.0, price: 180000, divYield: 3.2, growth1Y: 105.5 },
  { ticker: '086790', name: '하나금융지주', sector: '금융', per: 5.8, roe: 12.5, dividendYears: 12, pbr: 0.8, price: 130000, divYield: 4.2, growth1Y: 113.5 },
  { ticker: '316140', name: '우리금융지주', sector: '금융', per: 5.2, roe: 9.5, dividendYears: 5, pbr: 0.6, price: 28500, divYield: 5.5, growth1Y: 85.2 },
  ...
  { ticker: '000810', name: '삼성화재', sector: '금융', per: 9.2, roe: 13.5, dividendYears: 25, pbr: 1.1, price: 485000, divYield: 2.8, growth1Y: 78.5 },
  // 자동차
  { ticker: '005380', name: '현대차', sector: '자동차', per: 6.5, roe: 13.8, dividendYears: 20, pbr: 0.9, price: 485000, divYield: 2.2, growth1Y: 57.3 },
  { ticker: '000270', name: '기아', sector: '자동차', per: 5.8, roe: 19.5, dividendYears: 15, pbr: 1.1, price: 195000, divYield: 3.2, growth1Y: 45.8 },
  ...
  // 철강/화학
  { ticker: '005490', name: 'POSCO홀딩스', sector: '철강', per: 8.5, roe: 5.2, dividendYears: 22, pbr: 0.4, price: 320000, divYield: 3.2, growth1Y: -15.8 },
  { ticker: '010130', name: '고려아연', sector: '철강', per: 12.5, roe: 9.5, dividendYears: 15, pbr: 1.5, price: 1650000, divYield: 1.2, growth1Y: 82.5 },
  ...
  // 통신
  { ticker: '017670', name: 'SK텔레콤', sector: '통신', per: 11.2, roe: 13.5, dividendYears: 20, pbr: 1.0, price: 78500, divYield: 4.5, growth1Y: 38.8 },
  { ticker: '030200', name: 'KT', sector: '통신', per: 8.8, roe: 9.2, dividendYears: 18, pbr: 0.6, price: 52500, divYield: 4.6, growth1Y: 28.5 },
  { ticker: '032640', name: 'LG유플러스', sector: '통신', per: 8.8, roe: 9.2, dividendYears: 15, pbr: 0.5, price: 12500, divYield: 5.2, growth1Y: 8.5 },
  // 전력/가스
  { ticker: '015760', name: '한국전력', sector: '유틸리티', per: 3.0, roe: 8.5, dividendYears: 8, pbr: 0.3, price: 40100, divYield: 1.8, growth1Y: 78.5 },
  ...
  { ticker: '032830', name: '삼성생명', sector: '금융', per: 9.5, roe: 8.2, dividendYears: 15, pbr: 0.7, price: 246000, divYield: 2.7, growth1Y: 148.0 },
  ...
  { ticker: '267260', name: 'HD현대일렉트릭', sector: '산업재', per: 28.5, roe: 22.8, dividendYears: 3, pbr: 6.5, price: 886000, divYield: 0.3, growth1Y: 265.0 },
  { ticker: '034020', name: '두산에너빌리티', sector: '산업재', per: 35.8, roe: 5.2, dividendYears: 2, pbr: 1.5, price: 18500, divYield: 0.8, growth1Y: 45.8 },
  { ticker: '042700', name: '한미반도체', sector: '기술', per: 18.5, roe: 32.5, dividendYears: 5, pbr: 5.8, price: 185000, divYield: 0.4, growth1Y: 125.8 },
